          ...
          >
            ...
            <div className={`flex justify-between mx-9 my-1.5`}>
              ...
              <div className={`text-sm `}>
                ...
                <p> تلفن : 09160462254 </p>
              </div>
              <div className={`text-sm `}>
                <p className={`mb-2`}>کدپستی : 6814183149</p>
                <p>شماره اقتصادی : 3436982237 </p>
              </div>
            </div>
          </div>
              ...
              <div className={`  `}>
                <div className={`flex justify-between `}>
                  ...
                  <div className={`flex  `}>
                    ...
                    <div
                      className={`   w-[55px] text-center text-nowrap text-sm border-l  py-2.5 border-black`}
                    >
                      {sp(sumNum)}
                    </div>
                    <div
                      className={`   w-[173px] text-center text-nowrap text-sm border-l py-2.5 border-black`}
                    ></div>
                    <div
                      className={`   w-[125px] text-center text-nowrap text-sm border-l  py-2.5 border-black`}
                    >
                      {sp(sumPay)}
                    </div>
                    <div
                      className={`    w-[94px] text-center text-nowrap text-sm border-l  py-2.5 border-black`}
                    >
                      {sp(sumOff)}
                    </div>
                    <div
                      className={`    w-[151px] -mr-2.5 text-center text-nowrap text-sm   py-2.5 border-black`}
                    >
                      {sp(sumPay - sumOff)}
                    </div>
                  </div>
